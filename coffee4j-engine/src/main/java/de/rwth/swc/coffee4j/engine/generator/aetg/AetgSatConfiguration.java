...
public class AetgSatConfiguration {
    ...
    private AetgSatConfiguration(AetgSatConfigurationBuilder builder) {
     ...
     */
    public static AetgSatConfigurationBuilder aetgSatConfiguration() {
        return new AetgSatConfigurationBuilder();
    }
     ...
     */
    public static class AetgSatConfigurationBuilder {
         ...
         */
        public AetgSatConfigurationBuilder reporter(Reporter reporter) {
         ...
         * @return the builder for method chaining
         */
        public AetgSatConfigurationBuilder model(TestModel model) {
         ...
         * @return the builder for method chaining
         */
        public AetgSatConfigurationBuilder withNumberOfCandidates(int numberOfCandidates) {
         ...
         * @return the builder for method chaining
         */
        public AetgSatConfigurationBuilder withNumberOfTries(int numberOfTries) {
