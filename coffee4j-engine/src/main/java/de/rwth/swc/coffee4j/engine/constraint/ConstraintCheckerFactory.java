...
public class ConstraintCheckerFactory {
    ...
    public DynamicHardConstraintChecker createDynamicHardConstraintChecker() {
        return new DynamicHardConstraintChecker(testModel, exclusionConstraints, errorConstraints);
    }
