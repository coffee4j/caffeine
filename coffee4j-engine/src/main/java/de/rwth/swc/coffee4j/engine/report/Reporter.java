...
public interface Reporter {
     ...
     * lazy de.rwth.swc.coffee4j.evaluation only if a {@link Reporter} is really interested in the report of the given level.
     *
     * @param level          the of the report. Must not be {@code null}
     ...
     *
     * @param assumptionKey the key for this assumption
     */
