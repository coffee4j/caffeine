...
class ResultQualityAnalysisTest {

    private static Stream<Arguments> testCaseProvider() {
        return Stream.of(
                Arguments.of(TestData.MODEL_1, "S0", TestData.TRACE_1,
                        List.of(Map.of(
                                PropertyKey.percentage("superPrecision"), 0,
                                PropertyKey.percentage("precision"), 0,
                                PropertyKey.percentage("recall"), 0,
                                PropertyKey.percentage("fscore"), 0),
                                Map.of(PropertyKey.percentage("superPrecision"), 1,
                                        PropertyKey.percentage("precision"), 1,
                                        PropertyKey.percentage("recall"), 0,
                                        PropertyKey.percentage("fscore"), 0),
                                Map.of(PropertyKey.percentage("superPrecision"), 1,
                                        PropertyKey.percentage("precision"), 1,
                ...
                Arguments.of(TestData.MODEL_LARGE, "S0", TestData.TRACE_LARGE,
                        List.of(Map.of(
                                PropertyKey.percentage("superPrecision"), 1,
                                PropertyKey.percentage("precision"), 0.5,
                                PropertyKey.percentage("recall"), 0.5,
                                PropertyKey.percentage("fscore"), 0.5))),
    ...
    void shouldComputeExpectedResults(TestModel model, String scenarioName, Trace trace,
        ...
        TraceAnalysis analysis = new ResultQualityAnalysis("superPrecision", "precision", "recall", "fscore");
