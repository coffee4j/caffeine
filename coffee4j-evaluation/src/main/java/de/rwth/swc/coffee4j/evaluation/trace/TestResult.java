...
/**
 * Specifies the result of a test. Either a test threw no exception and was therefore successful, or it has an exception
...
public final class TestResult {
     ...
     */
    private TestResult(Throwable causeForFailure) {
