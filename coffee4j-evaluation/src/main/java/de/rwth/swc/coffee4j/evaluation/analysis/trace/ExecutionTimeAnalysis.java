...
/**
 * {@link TraceAnalysis} that copies the execution time of an iteration.
 */
public final class ExecutionTimeAnalysis implements TraceAnalysis {
     ...
     * Constructor.
     *
     * @param key The key for the execution time metric value.
     */
    ExecutionTimeAnalysis(String key) {
    ...
    public Map<PropertyKey, Number> analyze(TestModel model, TestScenario testScenario, Trace trace, TraceIteration iteration) {
        ...
        return Map.of(PropertyKey.positiveInteger(key), iteration.getExecutionTime());
    }
